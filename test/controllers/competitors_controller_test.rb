...
class CompetitorsControllerTest < ActionController::TestCase
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post :create, competitor: { debate_club: @competitor.debate_club, name: @competitor.name, points: @competitor.points, rank: @competitor.rank, speech_club: @competitor.speech_club, state: @competitor.state }
    end
  ...
  test "should update competitor" do
    patch :update, id: @competitor, competitor: { debate_club: @competitor.debate_club, name: @competitor.name, points: @competitor.points, rank: @competitor.rank, speech_club: @competitor.speech_club, state: @competitor.state }
    assert_redirected_to competitor_path(assigns(:competitor))
  end
